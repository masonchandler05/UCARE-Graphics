---
title: "Analysis of census visuals.R"
author: "Mason Chandler"
format: html
editor: visual
---

# Analysis of the accuracy of Visuals

```{r}
#| echo: false 
knitr::opts_chunk$set(
  echo = FALSE,      # hides code
  message = FALSE,   # hides library() messages
...
## Plotting the Micro-sample data against the pixel measurements
...
## Plotting available 100% census data against Pixel Measurements
...
### Plotly representations of the graphics
...
#Virginia is the main outlier in every graph. Its size was over represented in each and every
```

## Graphing Horizontal Pixel Measurements against Vertical Pixel Measurements
...
### Plotly Representation of data where it was innaccurate
...
## Plotting (Vertical - Horizontal) vs Population

The purpose of this is test for misshaped circles comparatively to its size
